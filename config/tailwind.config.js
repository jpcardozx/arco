...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Modern CSS variable-based system
      ...
      fontSize: {
        ...
        'headline-xl': ['2.25rem', { lineHeight: '1.3', fontWeight: '600' }],
        'headline-lg': ['1.875rem', { lineHeight: '1.3', fontWeight: '500' }],
        'headline-md': ['1.5rem', { lineHeight: '1.4', fontWeight: '500' }],
