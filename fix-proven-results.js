// Script to fix ProvenResults.tsx and remove all i18n dependencies
const fs = require('fs');
const path = require('path');

// Read the ProvenResults.tsx file
const filePath = 'c:/Users/João Pedro Cardozo/projetos/arco/src/components/sections/ProvenResults.tsx';

// Create a simplified ProvenResults component without i18n
...
try {
    ...
    console.log('✅ ProvenResults.tsx fixed successfully!');
} catch (error) {
    console.error('❌ Error fixing ProvenResults.tsx:', error);
}
