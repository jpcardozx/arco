-- Seed mínimo funcional para testar o sistema
-- Apenas dados essenciais sem foreign keys complexas

-- Inserir checklist diretamente (sem client profile por enquanto)
