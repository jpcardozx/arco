...
>(({ className, inset, destructive = false, withIcon = false, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive && 'text-red-600 focus:text-red-700 dark:text-red-500 dark:focus:text-red-400',
      withIcon && 'pl-7', // Space for an icon
      className
    )}
    {...props}
  />
