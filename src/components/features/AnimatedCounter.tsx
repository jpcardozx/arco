...
export function ImpactMetric({
  ...
  return (
    <div className={`portfolio-metric-card ${highlight ? 'border-blue-500' : ''}`}>
      <p className="mb-1 text-sm uppercase tracking-wider text-neutral-500">{label}</p>
      <p
        className={`text-3xl font-bold ${highlight ? 'text-blue-500' : 'text-neutral-800 dark:text-white'}`}
      >
