                ...
                <div className="grid gap-10 md:grid-cols-2">
                  <div>
                    ...
                    <h3 className="mb-6 text-2xl font-medium">
                      Sua empresa {industry.charAt(0).toUpperCase() + industry.slice(1)} está perdendo
                      aproximadamente
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 p-6 shadow-lg">
                      ...
                      >
                        Obtenha Seu ArcSight Snapshot™
                        <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                      </Link>

                      <p className="mt-3 text-sm text-blue-200">Limitado a 3 empresas por mês</p>
                    </div>
                  </div>
                </div>
              </div>
