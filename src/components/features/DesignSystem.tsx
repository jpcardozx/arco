...
export function Heading1({
  ...
  return (
    <h1 className={`heading-1 font-serif text-4xl md:text-5xl lg:text-6xl ${className}`}>
      {children}
    </h1>
  );
}
...
export function Heading2({
  ...
  return <h2 className={`heading-2 font-serif text-3xl md:text-4xl ${className}`}>{children}</h2>;
}
...
export function Heading3({
  ...
  return <h3 className={`heading-3 font-serif text-2xl md:text-3xl ${className}`}>{children}</h3>;
}
...
export function Button({
  ...
  const iconClasses = icon ? (iconPosition === 'left' ? 'flex-row gap-2' : 'flex-row gap-2') : '';
...
export function Section({
  ...
  return (
    <section className={`${baseClasses} ${colorClasses} ${borderClasses} ${className}`}>
      {withContainer ? (
        <div className={`container mx-auto px-6 ${maxWidthClasses[maxWidth]}`}>{children}</div>
      ) : (
        children
      )}
    </section>
...
export function Stat({
  ...
  return (
    <div className={`${baseClasses} ${className}`}>
      <p className={`${textSizeClasses[textSize]} ${accentColorClasses[accentColor]}`}>{value}</p>
