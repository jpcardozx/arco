  ...
  en: {
    ...
    homepage: {
      ...
      process: {
        ...
        step1: 'Analysis',
        step1Description:
          'We identify exactly where your customers abandon due to technical frustrations and calculate how much this is costing your company monthly.',
        step2: 'Strategy',
        step2Description:
          'We apply fixes to the 3 points that drive away most of your customers, recovering revenue that should already be yours.',
        step3: 'Implementation',
        step3Description:
          'Our team quickly implements the changes without disrupting your operations.',
        step4: 'Optimization',
        step4Description:
          'Track the real increase in your revenue every week, with clear reports connected directly to your financial tools.',
      },
      caseStudies: {
    ...
    solutions: {
      ...
      growth: {
        title: 'Proven Growth',
        description:
          'Track the real increase in your revenue every week, with clear reports connected directly to your financial and analytics tools.',
  ...
  pt: {
    ...
    homepage: {
      hero: {
        ...
        subtitle:
          'Otimização baseada em dados para empresas que buscam maximizar o desempenho digital',
      ...
      process: {
        ...
        step1: 'Análise',
        step1Description:
          'Identificamos exatamente onde seus clientes abandonam devido a frustrações técnicas e calculamos quanto isso está custando para sua empresa mensalmente.',
        step2: 'Estratégia',
        step2Description:
          'Aplicamos correções nos 3 pontos que afastam a maioria dos seus clientes, recuperando receita que já deveria ser sua.',
        step3: 'Implementação',
        step3Description:
          'Nossa equipe implementa as mudanças rapidamente sem interromper suas operações.',
        step4: 'Otimização',
        step4Description:
          'Acompanhe o aumento real na sua receita todas as semanas, com relatórios claros conectados diretamente às suas ferramentas financeiras.',
      },
      caseStudies: {
    ...
    solutions: {
      ...
      growth: {
        ...
        description:
          'Acompanhe o aumento real na sua receita todas as semanas, com relatórios claros conectados diretamente às suas ferramentas financeiras e analíticas.',
  ...
  es: {
    ...
    homepage: {
      hero: {
        ...
        subtitle:
          'Optimización basada en datos para empresas que buscan maximizar el rendimiento digital',
      ...
      process: {
        ...
        step1: 'Análisis',
        step1Description:
          'Identificamos exactamente dónde tus clientes abandonan debido a frustraciones técnicas y calculamos cuánto le está costando a tu empresa mensualmente.',
        step2: 'Estrategia',
        step2Description:
          'Aplicamos correcciones en los 3 puntos que alejan a la mayoría de tus clientes, recuperando ingresos que ya deberían ser tuyos.',
        step3: 'Implementación',
        step3Description:
          'Nuestro equipo implementa los cambios rápidamente sin interrumpir tus operaciones.',
        step4: 'Optimización',
        step4Description:
          'Sigue el aumento real en tus ingresos cada semana, con informes claros conectados directamente a tus herramientas financieras.',
      },
      caseStudies: {
    ...
    solutions: {
      ...
      growth: {
        ...
        description:
          'Sigue el aumento real en tus ingresos cada semana, con informes claros conectados directamente a tus herramientas financieras y analíticas.',
  ...
  fr: {
    ...
    homepage: {
      hero: {
        ...
        subtitle:
          'Optimisation basée sur les données pour les entreprises cherchant à maximiser leur performance digitale',
      ...
      process: {
        ...
        step1: 'Analyse',
        step1Description:
          'Nous identifions exactement où vos clients abandonnent en raison de frustrations techniques et calculons combien cela coûte à votre entreprise mensuellement.',
        step2: 'Stratégie',
        step2Description:
          'Nous appliquons des corrections aux 3 points qui éloignent la plupart de vos clients, récupérant des revenus qui devraient déjà vous appartenir.',
        step3: 'Implémentation',
        step3Description:
          'Notre équipe implémente rapidement les changements sans perturber vos opérations.',
        step4: 'Optimisation',
        step4Description:
          "Suivez l'augmentation réelle de vos revenus chaque semaine, avec des rapports clairs connectés directement à vos outils financiers.",
      },
      caseStudies: {
        title: 'Réussites',
    ...
    solutions: {
      ...
      growth: {
        ...
        description:
          "Suivez l'augmentation réelle de vos revenus chaque semaine, avec des rapports clairs connectés directement à vos outils financiers et analytiques.",
