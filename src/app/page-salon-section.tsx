...
export function SalonServicesForHomepage() {
  ...
  const featuredServices = [
    ...
    },
    {
      ...
      emoji: ICONS.spaTreatment.emoji,
    ...
    },
    {
      ...
      emoji: ICONS.eyelashExtension.emoji,
    ...
    },
    {
      ...
      emoji: ICONS.makeupArtist.emoji,
