...
export default function PasswordChangeForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isOwnPassword) {
                const isValid = await PasswordAuthorizationManager.validate(currentUser.id, request.currentPassword);
                if (!isValid) {
                    setResult({ type: 'error', message: 'Senha atual incorreta.' });
                    setLoading(false);
                    return;
                }
            }
            ...
            await PasswordAuthorizationManager.change(targetUserId || currentUser.id, request.newPassword);
