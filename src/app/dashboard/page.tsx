...
import { LineChart, TrendingUp, Activity, AlertCircle } from 'lucide-react'
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Execute sua primeira análise técnica para começar a monitorar seu site
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/assessment">
                <Button>Nova Análise Técnica</Button>
              </Link>
            </CardContent>
          </Card>
        </TabsContent>
