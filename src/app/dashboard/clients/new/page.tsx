...
import type { ClientInput } from '@/lib/types/supabase-helpers';
...
export default function NewClientPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const clientCode = await ClientsServiceWrapper.generateClientCode();
            ...
            const newClient = await ClientsServiceWrapper.createClient(clientData)
