...
import { AliquotasPDFService } from '@/lib/services/pdf-aliquotas-service'
  ...
  const performPDFGeneration = async (action: 'download' | 'send') => {
    ...
    try {
      ...
      if (action === 'download') {
        ...
        // TODO: Implement AliquotasPDFService.downloadPDF
        // await AliquotasPDFService.downloadPDF(pdfData, filename)
        console.log('PDF download not implemented yet:', filename, pdfData)
        alert(`PDF gerado com sucesso!\nArquivo: ${filename}\n\n⚠️ Download automático em desenvolvimento`)
      }
