                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <div className="space-y-2 text-sm text-gray-600">
                                    <div className="flex justify-between">
                                        ...
                                        <span>{(user as any)?.lastLogin ? new Date((user as any).lastLogin).toLocaleString('pt-BR') : 'Nunca'}</span>
                                    </div>
                                    <div className="flex justify-between">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="capitalize">{(user as any)?.status || 'active'}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span>Nível de acesso:</span>
                                        <span className="capitalize">{(user as any)?.role || 'Usuário'}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
