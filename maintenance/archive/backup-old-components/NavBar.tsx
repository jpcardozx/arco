...
export default function NavBar() {
    ...
    const [scrolled, setScrolled] = useState(false);    // Detects scrolling for conditional styling
    useEffect(() => {
        const handleScroll = () => {
    ...
    // Detects current section based on scrolling
    useEffect(() => {
    ...
    return (<header
        className={`fixed top-0 z-[100] w-full bg-neutral-50 border-b border-neutral-200 transition-all duration-900 backdrop-blur-sm ${scrolled ? 'shadow-xl py-4' : 'shadow-2xl py-8'}`}
    >
