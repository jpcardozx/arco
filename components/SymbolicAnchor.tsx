...
import { FiEye, FiDollarSign, FiArrowRight, FiCheckCircle, FiArrowDown, FiAlertCircle } from 'react-icons/fi'
        ...
        <section className="py-20 bg-white overflow-hidden">
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-neutral-900 leading-tight max-w-3xl mx-auto mb-6">
                ...
                <div className="bg-gradient-to-br from-neutral-50 to-blue-50 rounded-2xl overflow-hidden border border-neutral-100 shadow-lg mb-20">
                    <div className="p-8 md:p-10">
                        <div className="grid md:grid-cols-2 gap-10">
                            ...
                            <div className="bg-white rounded-xl border border-neutral-200 p-6 shadow-sm">
                                ...
                                <ul className="space-y-3 mb-6">                                    {perceptionGaps[industry]?.map((gap: string, i: number) => (
                ...
                <div className="text-center max-w-3xl mx-auto">
                    <h3 className="text-2xl md:text-3xl font-serif text-neutral-900 mb-6">
                    ...
                    <Link
                        href="/diagnose"
                        className="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-lg font-medium shadow-lg hover:bg-blue-700 transition-colors group"
                    >
