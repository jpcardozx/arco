...
import { Button, Card, Heading1, Heading2, Heading3, BodyLarge, Section, Grid } from './ui/DesignSystem'
...
export default function HeroARCORevised() {
    ...
    return (
        <>
            ...
            <Section
                dark={true}
                className="min-h-screen overflow-hidden pt-32 pb-24"
                withContainer={true}
                maxWidth="xl"
            >
                ...
                >
                    ...
                    <Heading1 className="text-white leading-tight max-w-4xl mx-auto mb-5">
                    ...
                    <BodyLarge className="text-neutral-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Methodology Section */}
            <Section dark={true} className="py-20 border-t border-neutral-800/50">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7 }}
                ...
                >
                    ...
                    <BodyLarge className="text-neutral-300 max-w-2xl mx-auto">
            ...
            <Section
                dark={true}
                className="bg-gradient-to-b from-neutral-900/50 to-blue-900/20 border-t border-neutral-800/30"
                maxWidth="md"
            >
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                ...
                >
                    ...
                    <BodyLarge className="text-neutral-300 max-w-2xl mx-auto mb-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10">
                        <motion.div
                            ...
                            whileTap={{ scale: 0.98 }}
                        >
                            <Link href="/diagnose" className="relative inline-flex items-center justify-center group">
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full opacity-90 blur-sm transition-all duration-200 group-hover:blur-md"></div>
                                <span className="relative bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 px-8 py-4 rounded-full text-white font-medium inline-flex items-center">
                                    Get your ArcSight Snapshot™ — $147
                    ...
                    <Card variant="ghost" className="inline-block backdrop-blur-sm border border-neutral-700/50 px-6 py-4">
                        <div className="flex items-center gap-3">
                            <Image src="/seal-grid-removebg-preview.png" alt="Limited availability seal" width={24} height={24} className="opacity-90" />
