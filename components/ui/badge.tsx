    ...
    "inline-flex items-center rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:focus:ring-neutral-300",
    {
        variants: {
            variant: {
                ...
                outline:
                    "text-neutral-950 dark:text-neutral-50 border-neutral-200 dark:border-neutral-800",
                success:
                    "border-transparent bg-green-500 text-white dark:bg-green-900 dark:text-green-100",
                warning:
                    "border-transparent bg-amber-500 text-white dark:bg-amber-900 dark:text-amber-100",
                info:
                    "border-transparent bg-blue-500 text-white dark:bg-blue-900 dark:text-blue-100",
                premium:
...
export function Badge({
    ...
    const iconElement = withIcon && icon && (
    ...
    const removeButton = removable && (
        <button
            ...
            className="ml-1.5 -mr-1 h-3.5 w-3.5 rounded-full text-neutral-500/80 hover:bg-neutral-400/20 hover:text-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 inline-flex items-center justify-center"
            aria-label="Remove"
        >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3">
