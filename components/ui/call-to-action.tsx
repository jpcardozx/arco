...
function CallToActionComponent({
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <div className={cn(
                'relative z-10 container mx-auto px-4 flex flex-col gap-8',
                alignClasses[align]
            )}>
                {withAnimation ? (
                    <motion.div
                    ...
                    >
                        {subtitle && (
                            <motion.div variants={itemVariants}>
                                <span className="text-sm md:text-base uppercase tracking-wider font-medium opacity-80">
                                    {displaySubtitle}
                                </span>
                            </motion.div>
                        )}
            ...
            {withAccentElement && (
                <div className={cn(
                    'absolute w-48 h-48 md:w-64 md:h-64 bg-blue-500/20 rounded-full blur-3xl',
                    accentPosition === 'top-left' ? '-top-24 -left-24' : '-bottom-24 -right-24'
                )} />
            )}
        </Section>
    )
