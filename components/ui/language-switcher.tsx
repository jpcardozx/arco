...
export function LanguageSwitcher({
    ...
    const buttonStyles = {
        minimal: "p-2 text-neutral-700 hover:bg-neutral-100 rounded-full dark:text-neutral-300 dark:hover:bg-neutral-800",
        compact: "px-3 py-2 text-neutral-700 hover:bg-neutral-100 rounded-lg dark:text-neutral-300 dark:hover:bg-neutral-800",
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className={cn(
                                "absolute z-50 min-w-[180px] bg-white dark:bg-neutral-800 rounded-lg p-1 shadow-lg border border-neutral-200 dark:border-neutral-700",
                            ...
                            <div className={
                                ...
                                {languages.map(language => (
                                    <button
                                        ...
                                        className={cn(
                                            "flex items-center gap-2 w-full px-3 py-2 text-left rounded-md text-sm",
