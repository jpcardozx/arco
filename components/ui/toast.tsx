...
function ToastContainer() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2 max-w-[420px] md:bottom-6 md:right-6">
...
function Toast({ toast, onClose }: { toast: Toast; onClose: () => void }) {
    ...
    const getToastClassNames = () => {
        const baseClasses = "bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-4 w-full max-w-md flex items-start gap-3 border"
